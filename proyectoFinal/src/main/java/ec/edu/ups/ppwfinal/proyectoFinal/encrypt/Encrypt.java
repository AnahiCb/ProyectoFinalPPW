package ec.edu.ups.ppwfinal.proyectoFinal.encrypt;
...
public class Encrypt implements Serializable {
    ...
    private static final String secretKeyAES = "proyectofinalPPW59";
    private static final String saltAES = "proyectofinal123";
